...
def test_basic(qtbot):
    """
    testing some basic stuff before i go into more advanced things
    """
    shell = launchShell([], [], [])
    qtbot.addWidget(shell)
    print(shell)
    shell.createAndLoadNewProject('projFilePath.ilp', PixelClassificationWorkflow)
    workflow = shell.projectManager.workflow

    from ilastik.applets.dataSelection.opDataSelection import DatasetInfo
    info = DatasetInfo()
    SAMPLE_DATA = 'test.npy'
    info.filePath = SAMPLE_DATA
    ...
    #     shell.thunkEventHandler.post(impl)
    ...
    # def impl():
    #     projFilePath = 'test.ilp'
    #     SAMPLE_DATA = 'test.npy'

    #     # New project
    #     shell.createAndLoadNewProject(projFilePath, PixelClassificationWorkflow)
    #     workflow = shell.projectManager.workflow
...
class TestPixelClassificationGuiPytest(object):
    """Class for duplicating our current approach of testing
    """
    @classmethod
    def setup_class(cls):
    ...
    def test_1_NewProject(self):
        ...
        # TODO: should be setup method, no testing done here.
        """
        def impl():
...
@pytest.mark.skip(reason="replacing this")
